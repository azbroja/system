...
<head>
    ...
    <title>Reklamacja {{$complaint->number}}</title>
...
<table>
  ...
  @if ($complaint->buyer_address_delivery)
  <strong> {!! str_replace("\n", "</strong> <br><strong> ", ($complaint->buyer_address_delivery)) !!}  </strong><br />
@else
    ...
    <table class="table-hover" border="1" cellspacing="1" cellpadding="10">
      <tr>
        ...
        <td class='gray_td'>Nazwa</td>
            ...
            @foreach ($complaint_products as $product)
      ...
      <td align='left' valign='top' width='50%'>
          <table border='0' width='100%'><tr>
            <td valign=top width=70><b>Opis usterki: </b></td>

            <td align=left valign=top>{!! str_replace("\n", "<br> ", ($complaint->comments)) !!}</td>
            </tr></table>
      </td>
      </div>
      </body>

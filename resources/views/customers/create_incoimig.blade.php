...
<div class="container">
    <div class="row justify-content-center">
        <div class="">
            <div class="card">
                <div class="card-header">{{ __('Dodaj dostawcę') }}</div>
...
<div class="col-md-6">
    ...
    @endif
     ...
     <label for="city" class="col-md-4 col-form-label text-md-right">{{ __('Miasto') }}</label>
                            ...
                            <label for="bank_account_number" class="col-md-4 col-form-label text-md-right">{{ __('Numer Konta Bankowego') }}</label>

<div class="col-md-6">
    <textarea id="bank_account_number" type="text" class="form-control{{ $errors->has('bank_account_number') ? ' is-invalid' : '' }}" name="bank_account_number" value="" autofocus></textarea>
...
<label for="address_delivery" class="col-md-4 col-form-label text-md-right">{{ __('Adres Dostway') }}</label>

<div class="col-md-6">
    <textarea id="address_delivery" type="text" class="form-control{{ $errors->has('address_delivery') ? ' is-invalid' : '' }}" name="address_delivery" value="" autofocus></textarea>
    ...
    @endif
     ...
     <label for="www" class="col-md-4 col-form-label text-md-right">{{ __('Adres strony www') }}</label>
        ...
        <label for="type" class="col-md-4 col-form-label text-md-right">{{ __('Typ Klienta') }}</label>
                            ...
                            <div class="col-md-6">
                                <input id="type" type="text" class="form-control{{ $errors->has('type') ? ' is-invalid' : '' }}" name="type" value="Dostawca" autofocus>

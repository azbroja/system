    ...
    width: 100%;
        ...
        <div class="container">
            <div class="card">
                ...
                <div class="card-header">Dodaj korektę faktury</div>
                <div class="card-body">
...
@endif
                        ...
                        <div class="col-md-12">
                            ...
                            <textarea rows="4" id="comments" type="text" class="form-control{{ $errors->has('comments') ? ' is-invalid' : '' }}"
                                name="comments" value="" autofocus>{{$invoiceComments ? $invoiceComments : 'ZWROT' }}</textarea>
...
<br>
                    <div class="">
                        ...
                        <form method="post" id="sendProductsForm">
                            ...
                            <input type="submit" class="btn btn-primary" id="save" value="Generuj Korektę">
...
<script src="{{ asset('js/hardwareCorrection.js') }}"></script>

function addProduct(product) {
    ...
    sellingPriceInput.name = product !== undefined ? 'complaint_products_prices[' + product.id + '][net_unit_price]' : '';
    ...
    quantity.type = 'text';
    quantity.name = product !== undefined ? 'complaint_products_prices[' + product.id + '][quantity]' : '';
    ...
    deleteLink.classList.add('delete-complaint');
...
document.querySelector('.add-complaint-product').addEventListener('click', e => {
    addProduct();
});

document.querySelector('.complaints-table').addEventListener('change', e => {
    ...
    if (product !== undefined) {
        ...
        sellingPriceInputName = 'complaint_products_prices[' + product.id + '][net_unit_price]';
        quantityName = 'complaint_products_prices[' + product.id + '][quantity]';
...
document.querySelector('.complaints-table').addEventListener('click', e => {
    if (!e.target.classList.contains('delete-complaint')) {
        return;
    }
...
complaintProducts.forEach(product => {
    addProduct(product);
});
